...
/**
 * Bosses are strong, multi-demensional creatures that players need to be wary
 * around. They tend to have 1-2 single target abilities, along with an AEO
 * ability. You usually only see one, but tagged along with some minions.
 */
