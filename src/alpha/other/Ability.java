...
/**
 * All "Entities" (Enemies, playable characters, and other living things that
 * fight all have abilities. The "Ability" class helps by taking care of the
 * damage, naming, and determining if is an AOE attack.
 */
public class Ability {
	...
	/**
	 * All abilities will have 1 of 4 types. These types will be implemented later
	...
	/**
	 * Default constructor will make an ability with no real name, a base damage of
	 * 10, and not being AOE(Area of Effect). These can be changed after if wanted
	 * to.
	 */
	public Ability() {
	 ...
	 * @param isAOE  Used with a different function to deterime if a ability is AOE
	 *               (Area of Effect).
	 */
